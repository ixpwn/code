    ...
    We also showed that the global AS graph as a whole is strongly connected, with a minimum of \kristin{k} regions requiring complete obliteration to fully halve the Internet, with half of all prefixes in a partition leaving them fully unable to communicate with any prefix in the other partition.
