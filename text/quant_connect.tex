...
\end{figure}
    ...
    We note that, while 84\% of networks are `stub' networks, providing transit to no one, usually with few providers and limited geographic extent, we focus our analysis to networks which provide transit to other networks.
