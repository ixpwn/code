...
\title{Modeling Regional Failures and Interdomain Connectivity}
...
\begin{document}    
    ...
    \abstract{\it
        ...
        In this paper, we develop a model to explore the impact of regional failures on AS connectivity.
        We map logical AS connectivity links to redundant geographic peering connections, developing metrics to quantify `regional peering diversity.' 
