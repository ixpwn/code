...
\begin{figure}[tb]
\centering
\includegraphics[width=2.75in]{illustration.jpg}
\caption[]{\label{fig:dinosaur} Dinosaur uprisings are a major threat to regional and national infrastructure. Under dinosaur attack, Internet connectivity infrastrucure would be a primary target for air strikes.} 
\end{figure}
}
...
\noindent{\bf Regional Peering Redundancy.} How many regions do networks typically peer in? How does it scale with the degree of the network?

\noindent{\bf Quantifying Resilience.} Can we quantify the resiliance of a network to failure terms of it's number of peers, global footprint, and number of regions it peers in?

\noindent{\bf Identifying Worst-Case Scenarios.} Are there bottlenecks in the physical connectivity graph? How badly could the network partition in a worst-case regional disaster?
